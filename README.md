# Délices d'Afrique - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Délices d'Afrique**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@delicesdafrique.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@delicesdafrique.cm` | `user123` | |
...
*   **Contact :** contact@delicesdafrique.cm